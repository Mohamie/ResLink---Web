...
namespace ResLink.DAL.Repositories
{
    public class ResidenceManagerRepository
    {
        ...
        public static async Task SetRelation<ResidenceManager>(ResidenceManager parentObject, string relationColumnName, object[] children)
        {
            await instance.db.SetRelation<ResidenceManager>(parentObject, relationColumnName, children);
        }
    }
}
